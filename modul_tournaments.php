...
function Menu(){
	...
	$res = mysql_query("SELECT tournament_id FROM "._DB_TOURNAMENTS) or die ("<strong>File:</strong> ".__FILE__."<br /><strong>Line:</strong>".__LINE__."<br />".mysql_error());
...
function ShowMain(){
	...
	$res_num = mysql_query("SELECT COUNT(*) AS suma FROM "._DB_TOURNAMENTS) or die ("<strong>File:</strong> ".__FILE__."<br /><strong>Line:</strong>".__LINE__."<br />".mysql_error());
	...
	FROM "._DB_TOURNAMENTS." AS t 
	LEFT JOIN "._DB_ADMINS." AS a ON t.tournament_admin_id=a.admin_id 
...
function AddTournament(){
	...
	if ($_GET['action'] == "tournament_edit"){
		$res = mysql_query("SELECT * FROM "._DB_TOURNAMENTS." WHERE tournament_id=".(integer)$_GET['id']) or die ("<strong>File:</strong> ".__FILE__."<br /><strong>Line:</strong>".__LINE__."<br />".mysql_error());
...
function DeleteTournament(){
	...
	echo "	<tr>\n";
	echo "		<td valign=\"top\">\n";
					$res = mysql_query("SELECT tournament_name, tournament_date FROM "._DB_TOURNAMENTS." WHERE tournament_id=".(integer)$_GET['id']) or die ("<strong>File:</strong> ".__FILE__."<br /><strong>Line:</strong>".__LINE__."<br />".mysql_error());
					$ar = mysql_fetch_array($res);
