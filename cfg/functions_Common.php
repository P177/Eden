...
*
***********************************************************************************************************/
function AlphabethSelect($letter){
	
	if ($letter == "A"){return "'a%' OR 'á%'";}
	if ($letter == "B"){return "'b%'";}
	if ($letter == "C"){return "'c%' OR 'c%'";}
	if ($letter == "D"){return "'d%' OR 'd%'";}
	if ($letter == "E"){return "'e%' OR 'é%' OR 'e%'";}
	if ($letter == "F"){return "'f%'";}
	if ($letter == "G"){return "'g%'";}
	if ($letter == "H"){return "'h%'";}
	if ($letter == "I"){return "'i%' OR 'í%'";}
	if ($letter == "J"){return "'j%'";}
	if ($letter == "K"){return "'k%'";}
	if ($letter == "L"){return "'l%' OR 'l%'";}
	if ($letter == "M"){return "'m%'";}
	if ($letter == "N"){return "'n%' OR 'ÿ%'";}
	if ($letter == "O"){return "'o%' OR 'ó%'";}
	if ($letter == "P"){return "'p%'";}
	if ($letter == "Q"){return "'q%'";}
	if ($letter == "R"){return "'r%' OR 'r%'";}
	if ($letter == "S"){return "'s%' OR 'š%'";}
	if ($letter == "T"){return "'t%' OR 't%'";}
	if ($letter == "U"){return "'u%' OR 'ú%'";}
	if ($letter == "V"){return "'v%'";}
	if ($letter == "W"){return "'w%'";}
	if ($letter == "X"){return "'x%'";}
	if ($letter == "Y"){return "'y%' OR 'ý%'";}
	if ($letter == "Z"){return "'z%' OR 'ž%'";}
