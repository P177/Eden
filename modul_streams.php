...
function ShowMain(){
	...
	$res = mysql_query("SELECT article_id, article_date, article_date_on, article_date_off, article_category_id, article_headline, article_perex, article_author_id, article_user_use, 
...
function EdiTor($id,$act,$action){
	...
	global $db_articles,$body,$db_category,$db_admin,$db_language;
	global $eden_cfg;
	global $url_articles;
